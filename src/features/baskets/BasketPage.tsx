...
import {  Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography ,Grid, Button, Box } from "@mui/material";
...
export default function BasketPage(){
    ...
    function handleRemoveItem(productId:number,quantity=1,name:string)
    {
     ...
     if(!basket) return <Typography variant='h3'>Your baseket is empty</Typography>
    return(
      <>
            ...
            {basket.items.map((item) => (
              ...
              >
                ...
                <TableCell align="right">
                    <LoadingButton loading={status.loading && status.name==='del'} 
